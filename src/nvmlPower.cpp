...
void GPUPowerBegin(const char *alg, int ms, int dev){
    ...
    GPUfilename = std::string("data_rmq/") + std::string("power-") + std::string(alg) + std::string(".dat");
...
void CPUPowerBegin(const char *alg, int ms){
    ...
    CPUfilename = std::string("data_rmq/") + std::string("power-") + std::string(alg) + std::string(".dat");
    rapl = new Rapl();
